...
class disk:
    ...
    def prepare(self, Combinations, R_min, R_max, N, spacing):
        self.Grid = Combinations
        self.R_min = R_min
        self.R_max = R_max
        self.N = N
    ...
    def sample(self, INPUT, i):
        ...
        N_planetesimals, TotalMass, Sigma_Coeff = self.Grid[i - 1, :]
        ...
        return Sigma_Coeff, Sigma_Norm * denstos * (R_S / au) ** Sigma_Coeff, Temp_Coeff, N_planetesimals, TotalMass
